...
class ResNet(nn.Module):
    ...
    def __init__(self, input_shape, hidden_dim=128, num_classes=10, k=1, n=1):
        ...
        self.unfold = nn.Unfold(kernel_size=1)
        self.lstm = nn.LSTM(input_size=self.width[4], hidden_size=hidden_dim, num_layers=1, batch_first=True)
...
if __name__ == "__main__":
    model = ResNet((3, 32, 32), hidden_dim=128, num_classes=10)
